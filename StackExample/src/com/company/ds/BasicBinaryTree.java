...
public class BasicBinaryTree<X extends Comparable<X>> {
    ...
    public boolean delete(X item){
        ...
        if(currentNode != null){
            ...
            //if the node to delete has only a right child, remove it in the hierarchy
            ...
            //the node has both children, do a node swap to delete
                ...
                //you can swap out the node with the right most leaf on the left side
                ...
                child.getParent().setRight(null); //remove the left node from it's current position
    ...
    private Node getNode(X item){
        ...
        while(currentNode != null){
            ...
            //if the val is less than 0 it goes to the left
            else if (val < 0){
                currentNode = currentNode.getLeft();
            }
            //if the val is greater than 0 it goes on the right
            else{
    ...
    private void insert(Node parent, Node child){
        ...
        if(child.getItem().compareTo(parent.getItem()) < 0){
            //if the left child is null, we've found our spot
            if(parent.getLeft() == null){
                parent.setLeft(child);
                child.setParent(parent);
                this.size++;
            }
            //otherwise we need to call the insert again and  test for the left  or right (recursion)
            else {
        ...
        //if the child is greater than the parent, it goes on the right
            ...
            //if the right child is null, we've found our spot
            if(parent.getRight() == null){
                parent.setRight(child);
                child.setParent(parent);
                this.size++;
            }
            //otherwise we need to call insert again and test for the left or the right (recursion)
            else {
                insert(parent.getRight(), child);
            }
        }

        //if the parent and child are equal we are not going to do anything
        //the assumption is that the nodes are unique and no duplicate values are allowed
    }
